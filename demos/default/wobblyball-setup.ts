// === WebGL/WebGPU Compatible Shader Materials ===
// Note: ShaderMaterial works on both WebGL and WebGPU renderers.
// WebGPURenderer automatically transpiles GLSL shaders to WGSL.
// All shader code is self-contained in this demo.
...
// --- SOLID (faceted) PASS ---
// Created using TSL-compatible shader material
const baseMaterial = new THREE.ShaderMaterial({
  uniforms,
  vertexShader: /* glsl */ `
      varying vec3 vWorldPos;
      uniform float uTime; uniform float uAmp; uniform float uFreq; uniform float uSpeed;
      // Simplex noise implementation (Ashima Arts / Ian McEwan)
