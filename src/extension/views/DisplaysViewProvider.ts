...
export default class DisplaysViewProvider
  implements vscode.WebviewViewProvider
{
  public static readonly viewType = "visualFiha.displaysView";
  ...
  public resolveWebviewView(
    ...
    webviewView.webview.onDidReceiveMessage((data) => {
      console.info("[DisplaysViewProvider] onDidReceiveMessage", data);
    });
  }

  private _getHtmlForWebview(webview: vscode.Webview) {
    const assets = getMediaUri("displaysView", webview, this._extensionUri);
