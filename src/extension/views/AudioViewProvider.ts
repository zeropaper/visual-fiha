...
export default class AudioViewProvider implements vscode.WebviewViewProvider {
  public static readonly viewType = "visualFiha.audioView";
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    const assets = getMediaUri("audioView", webview, this._extensionUri);
